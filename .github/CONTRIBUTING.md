# Contributing to FDC3 Context Sender
...
As a result, PRs submitted to the FDC3 Context Sender project cannot be accepted until you have a CLA in place with the Foundation.
